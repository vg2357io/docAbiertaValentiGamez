...
**Objetivo:** que un empleado, creador de contenido o estudiante pueda desplegar su un sitio web, documento o pdf desde el bloc de notas:
1) **Fork** del repositorio [docsify](https://docsify.js.org/),
2) **Diseñar standard**,
3) **Conexión con Ariadna** para poder acceder a los servicios de la empresa/persona desde su red privada,
3) **Paquete** npm/pip para poder instalarlo en cualquier dispositivo,

**Resultado:** un comando que permite iniciar una carpeta con contenido en formato md y que despliega un sitio web, pdf o doc ligado con el software de empresa.
